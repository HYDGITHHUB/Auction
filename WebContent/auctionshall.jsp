...
<head>
        ...
        <title>拍卖大厅</title>
        <link rel="stylesheet" href="css/auctionshall.css">
</head>

<body>
        <div class="auctionshall-heard clearfix">
                <div class="auctions-heard-img">
                        <img src="jpg/auctions-heard-img.png" alt="auctions-heard-img">
                </div>
                <div class="auctions-heard-detail clearfix">
                        <span class="auctiosn-detail-green">同步拍</span>
                        <h3>
                                三岔子林业局那尔轰林场林产品红松果（塔）果实采集拍卖会
                        </h3>
                        <p>拍卖企业：吉林国际商品拍卖有限公司</p>
                        <p>联系电话：13504318030</p>
                        <div class="auctions-detail-time">
                                2019年12月10日&nbsp;15:33结束
                        </div>
                        <ul class="clearfix">
                                <li>
                                        <p class="auctions-detail-num">23</p>
                                        <p>标的数量</p>
                                </li>
                                <li>
                                        <p class="auctions-detail-num">64</p>
                                        <p>围观次数</p>
                                </li>
                        </ul>
                </div>
        ...
        <div class="auctions-ancm vanish">
                <div class="hall-annotation">
                        ...
                        <div class="h-a-h">
                                <div class="pai-remind-tip">
                                        ...
                                        <p><span style="font-size:20px"><span
                                                                style="color:#000000">十二、关于贷款：</span></span></p>
                                        ...
                                        <p><span style="font-size:20px"><span
                                                                style="color:#000000">十三、关于第三方服务：</span></span>
                                        </p>
...
<script src="js/auctionshall.js"></script>
